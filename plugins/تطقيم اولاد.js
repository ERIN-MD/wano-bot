...
let handler = async (m, { conn }) => {
  ...
  let data = await (await fetch('https://gist.githubusercontent.com/kdjrjidj/9d3ab3158d5c42934102969a6a854df4/raw/9df532996c0b034013eba6562d3aec8581264c41/xjsjjdjdjsd.jsonjjdjdjsd.json')).json()
